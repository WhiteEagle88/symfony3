...
RUN apt-get install -y php7.1 php7.1-cli php7.1-common php7.1-cgi php7.1-curl php7.1-imap \
    php7.1-mysql php7.1-fpm php7.1-intl php7.1-gd php7.1-json \
    php-memcached php-memcache php-imagick php7.1-xml php7.1-mbstring php7.1-ctype \
    php7.1-dev php-pear
...
RUN apt-get update
RUN echo "percona-server-server-5.7 percona-server-server-5.7/root-pass password root" | sudo debconf-set-selections
RUN echo "percona-server-server-5.7 percona-server-server-5.7/re-root-pass password root" | sudo debconf-set-selections
